...
(function (global) {
  ...
  function logCloudError(action, e) {
    if (e && e.code === "permission-denied") {
      console.error(
        "LotteryDB: " + action + " blocked by Firestore Security Rules " +
        "(permission-denied). Check Firebase Console \u2192 Firestore \u2192 Rules " +
        "and make sure lottery/data allows the access this page needs.",
        e
      );
    } else {
      console.error("LotteryDB: " + action + " failed", e);
    }
  }
